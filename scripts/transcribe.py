...
- N-gram анализ (2-8 слов) с adaptive threshold
- Короткие фразы (<5 слов) → 85%, длинные → 75%
- Gap-filled сегменты: threshold +10%
- Интегрирована в clean_hallucinations_from_text()
...
def main():
	...
	print("   ✅ N-gram анализ (2-8 слов) с adaptive threshold")
	print("   ✅ Короткие фразы (<5 слов) → 85%, длинные → 75%")
	print("   ✅ Gap-filled сегменты: threshold +10%")
	print()
