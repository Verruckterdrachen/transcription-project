#!/usr/bin/env python3
"""
transcribe_v16.py - Главный файл пайплайна транскрибации v16.10

🔥 v16.10: CONTINUATION PHRASE FIX В SPLIT
- Исправлен баг в split_mixed_speaker_segments
- Continuation phrases ("То есть", "В частности") больше не меняют спикера
- Использование контекста длинного монолога (>60s)
...
VERSION = "16.10"
VERSION_NAME = "Continuation Phrase Fix in Split"
...
def process_audio_file(
    ...
    # ═══════════════════════════════════════════════════════════════════════
    print("\n✂️ Разделение mixed-speaker сегментов (v16.10)...")
...
def main():
    ...
    print("=" * 70)
    print()
    print("💡 v16.10 ИЗМЕНЕНИЯ:")
    print("   ✅ Continuation phrase fix в split_mixed_speaker_segments")
    print("   ✅ Детекция 'То есть', 'В частности' и других continuation phrases")
    print("   ✅ Использование контекста длинного монолога (>60s)")
    print("   ✅ Защита от переатрибуции при переговоре фраз")
    print()
    print("💡 v16.9 ИЗМЕНЕНИЯ:")
    print("   ✅ Continuation phrase detection в весовой классификации")
    print()
