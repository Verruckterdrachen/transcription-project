#!/usr/bin/env python3
"""
transcribe_v16.py - Главный файл пайплайна транскрибации v16.19
...
VERSION = "16.19"
VERSION_NAME = "Critical Fix: Timestamps + Hallucinations + Continuation"
...
def process_audio_file(
    ...
    # ═══════════════════════════════════════════════════════════════════════
    print("\n✂️ Разделение mixed-speaker сегментов (v16.12)...")
