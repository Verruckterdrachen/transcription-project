...
6. TIMESTAMP DRIFT
Что: Совпадают ли timestamp в TXT с реальным аудио? Проверяем 3–5 точек вручную.
...
Что: Результат не хуже, чем golden dataset baseline v17.0?

bash
# Сравниваем с baseline
diff "test-results/latest/NW_Uckpa0001_01.txt" "golden-dataset/v17.0-baseline/NW_Uckpa0001_01.txt"
Проверяем:
...
[ ] 6. Timestamp drift  — 3–5 точек проверено в аудио
[ ] 7. Гапы             — все >3 сек объяснены
[ ] 8. Regression       — не хуже golden dataset v17.0
━━━━━━━━━━━━━━━━━━━━━━━━━
...
golden-dataset/v17.0-baseline/ — эталонные результаты

Последнее обновление: 2026-02-18
Актуальная версия: v17.0